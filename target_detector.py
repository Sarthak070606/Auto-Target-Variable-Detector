...
TARGET_KEYWORDS = [
    ...
    "target", "label", "labels", "output", "outcome", "response", " y", "Y", "class", "classes", "category", "result", "prediction", "ground_truth", "true_label", "annotation", "is_fraud", "is_spam", "is_churn", "is_default", "is_malignant", "is_canceled", "is_converted", "is_clicked", "is_purchased", "survived", "diagnosis", "sentiment", "emotion", "intent", "species", "type", "grade", "rating", "quality", "risk_level", "severity", "status", "approved", "accepted", "pass_fail", "readmitted", "price", "sales", "revenue", "cost", "salary", "income", "wage", "profit", "loss", "demand", "quantity", "temperature", "score", "value", "amount", "count", "rate", "duration", "age", "weight", "height", "bmi", "gdp", "stock_price", "house_price", "median_house_value", "charges", "tip", "fare", "rent", "life_expectancy", "mpg", "medv","diagnosis", "disease", "condition", "mortality", "survival", "prognosis", "readmission", "los", "cancer_type", "tumor_size", "blood_pressure", "glucose", "insulin", "bmi", "outcome", "death", "remission", "positive","default", "fraud", "churn", "credit_risk", "loan_status", "approval", "bankruptcy", "delinquency", "return", "volatility", "close_price", "next_day_price", "profit_loss", "credit_score", "purchased", "clicked", "converted", "churned", "basket_size", "ltv", "clv", "engagement", "open_rate", "bounce", "retention", "nps", "rainfall", "pollution_level", "co2_emission", "energy_consumption", "power_output", "wildfire_risk", "earthquake_magnitude", "flood_risk", "crop_yield", "soil_quality","accident", "delay", "eta", "traffic_volume", "fuel_efficiency", "crash_severity", "route_risk", "arrival_time","sentiment", "label", "category", "intent", "named_entity", "pos_tag", "toxicity", "spam", "topic", "language", "summary", "translation", "next_word", "answer","class_id", "label", "bounding_box", "mask", "keypoints", "depth", "pose", "object_detected", "caption", "age_estimated", "gender", "emotion","reward", "action", "win", "score", "move", "next_state","price", "sale_price", "rent", "median_value", "sqft_price", "days_on_market", "sold","grade", "score", "pass", "dropout", "gpa", "performance", "admission"
    "target", "label", "labels", "output", "outcome", "response", " y", "Y", "class", "classes", "category", "result", "prediction", "ground_truth", "true_label", "annotation", "is_fraud", "is_spam", "is_churn", "is_default", "is_malignant", "is_canceled", "is_converted", "is_clicked", "is_purchased", "survived", "diagnosis", "sentiment", "emotion", "intent", "species", "type", "grade", "rating", "quality", "risk_level", "severity", "status", "approved", "accepted", "pass_fail", "readmitted","price", "sales", "revenue", "cost", "salary", "income", "wage", "profit", "loss", "demand", "quantity", "temperature", "score", "value", "amount", "count", "rate", "duration", "age", "weight", "height", "bmi", "gdp", "stock_price", "house_price", "median_house_value", "charges", "tip", "fare", "rent", "life_expectancy", "mpg", "medv","diagnosis", "disease", "condition", "mortality", "survival", "prognosis", "readmission", "los", "cancer_type", "tumor_size", "blood_pressure", "glucose", "insulin", "bmi", "outcome", "death", "remission", "positive","default", "fraud", "churn", "credit_risk", "loan_status", "approval", "bankruptcy", "delinquency", "return", "volatility", "close_price", "next_day_price", "profit_loss", "credit_score","purchased", "clicked", "converted", "churned", "basket_size", "ltv", "clv", "engagement", "open_rate", "bounce", "retention", "nps","rainfall", "pollution_level", "co2_emission", "energy_consumption", "power_output", "wildfire_risk", "earthquake_magnitude", "flood_risk", "crop_yield", "soil_quality","accident", "delay", "eta", "traffic_volume", "fuel_efficiency", "crash_severity", "route_risk", "arrival_time","sentiment", "label", "category", "intent", "named_entity", "pos_tag", "toxicity", "spam", "topic", "language", "summary", "translation", "next_word", "answer","class_id", "label", "bounding_box", "mask", "keypoints", "depth", "pose", "object_detected", "caption", "age_estimated", "gender", "emotion","reward", "action", "win", "score", "move", "next_state","price", "sale_price", "rent", "median_value", "sqft_price", "days_on_market", "sold","grade", "score", "pass", "dropout", "gpa", "performance", "admission"
